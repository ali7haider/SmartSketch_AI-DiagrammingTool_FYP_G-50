...
function FileList() {
  ...
  console.log('FileListContext value:', context);

  if (!context) {
    throw new Error('FileListContext is undefined. Ensure the provider is wrapping the component tree.');
  }

  const { fileList_, setFileList_ } = context; // Destructure values from context
